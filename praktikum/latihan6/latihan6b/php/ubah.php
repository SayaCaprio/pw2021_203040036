...
<body>
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <input type="text" data-role="input" name="country" id="country" value="<?= $film['country'] ?>" class="mb-1" title="">
            <label for="sinopis">Sinopis movie</label>
            <input type="text" data-role="input" name="sinopis" id="sinopis" value="<?= $film['sinopis'] ?>" class="mb-1" title="">
